 ...
 */
package de.saar.minecraft.broker.db.tables;


import de.saar.minecraft.broker.db.Indexes;
import de.saar.minecraft.broker.db.Keys;
import de.saar.minecraft.broker.db.Minecraft;
...
public class Games extends TableImpl<GamesRecord> {
    ...
    private static final long serialVersionUID = 565271263;
     ...
     */
    public final TableField<GamesRecord, GamesStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(8).asEnumDataType(de.saar.minecraft.broker.db.enums.GamesStatus.class), this, "");
